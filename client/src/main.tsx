...
const redirectToLoginIfUnauthorized = (error: unknown) => {
  ...
  if (typeof window === "undefined" || error.data?.code !== "UNAUTHORIZED") return;
  if (window.location.pathname !== "/login") window.location.replace(`/login?redirect=${encodeURIComponent(window.location.pathname)}`);
};
